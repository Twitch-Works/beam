...
// Expo replaces EXPO_PUBLIC_* at build time via babel-plugin-transform-inline-environment-variables.
// The declare below tells TypeScript about the global so tsc doesn't error.
